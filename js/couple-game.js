const questions = [
  {
    q: "เดทแรกเค้าพาเธอไปที่ไหน",
    c: ["ice skate ", "หอศิลป์", "อควาเรียม"],
    correct: 0,
  },
  {
    q: "หนังเรื่องแรกที่เค้าพาไปดู",
    c: ["ธี่หยด 2", "Avatar 3", "Zootopia 2"],
    correct: 2,
  },
  {
    q: "ทายใจเค้าว่าเค้าอยากพาเธอไปที่ไหน",
    c: ["ดูหนัง", "ice skat ", "ทั้งคู่"],
    correct: 2,
  },
];
